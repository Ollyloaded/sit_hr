  ...
  <h1>Department Information</h1>
     <table style="width:100%">
           ...
           <th>Location ID</th>
			...
			$view_sql= mysqli_query($conn,"SELECT * FROM department_info");
			...
			<tbody>
			     <tr> 
					 ...
					 <td><?php echo $show['depId'] ?></td>
					 <td><?php echo $show['depName'] ?></td>
					 <td><?php echo $show['managerId'] ?></td>
					 <td><?php echo $show['locationId'] ?></td>
